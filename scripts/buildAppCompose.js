...
export async function buildAppCompose() {
  ...
  fs.writeFileSync('dist/android/AccorColorSemantics.kt', mergedContent);

  // Clean up temp files
  try {
    fs.unlinkSync('dist/android/_primitives_temp.kt');
    fs.unlinkSync('dist/android/_light_temp.kt');
    fs.unlinkSync('dist/android/_dark_temp.kt');
  } catch (e) {
    // Ignore if files don't exist
  }

  console.log('\nBuild complete! Output in dist/android/');
